        ...
        <div class="row align-items-center">
          <div class="col-12">
            <div class="row justify-content-center align-items-center text-center">
              <div class="col-lg-6">
                <h1 data-aos="fade-up" data-aos-delay="0" class="text-white">Arabic Language for kids</h1>
      ...
      <div class="row">
        <div class="col-lg-8 mb-5">
          ...
          <div class="mb-5">
            ...
            <p>Tutorial to learn the Arabic Language for the kids</p>
          </div>
          ...
          <div class="pt-5">
            ...
            <ul class="comment-list">
              ...
              <li class="comment">
                ...
                <div class="vcard bio">
                  <img src="../../../images/comment3.png" alt="Image placeholder">
                </div>
              ...
              <li class="comment">
                ...
                <div class="vcard bio">
                  <img src="../../../images/comment1.png" alt="Image placeholder">
                </div>
        ...
        <div class="col-lg-4 pl-lg-5">
          <div class="mb-5 text-center border rounded course-instructor">
            ...
            <div class="mb-4 text-center">
              ...
              <p>Arabic Khatawaat (Steps) is a series of recorded material to support Non-Arabic kids
                learn to read and write. Recognize Arabic sounds, connect Arabic letters,
