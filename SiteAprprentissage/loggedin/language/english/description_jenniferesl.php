        ...
        <div class="row align-items-center">
          <div class="col-12">
            <div class="row justify-content-center align-items-center text-center">
              <div class="col-lg-6">
                <h1 data-aos="fade-up" data-aos-delay="0" class="text-white">Learn English with Jennifer: Lessons for Kids</h1>
      ...
      <div class="row">
        <div class="col-lg-8 mb-5">
          ...
          <div class="mb-5">
            ...
            <p>American English for Kids! No actors. No scripts. Real lessons with real results.
            ...
            <ul class="comment-list">
              ...
              <li class="comment">
                ...
                <div class="comment-body">
                  <h3>Allexi Mami</h3>
                  <div class="meta">August 2, 2023 at 7:00pm</div>
